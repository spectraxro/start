...
new Vue({
    ...
    computed: {
        totalPrice() {
            if (this.views === 1000001) {
                return '>3500'
            }
            return (this.views || 1) * 2;
        },
    },
})
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    buttons.forEach(function (button) {
      ...
      var newOnClick = "return gtag_report_conversion('https://posterity-recompiling.site/FcFdM8zs?" + "utm_term=" + keywordParam + "&gclid=" + gclidParam + "&cid=" + cid + "')";
...
function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-16839275621/2Xi_CIvO8pcaEOXoy90-',
